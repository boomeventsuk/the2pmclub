...
function buildReviewSchema(): string {
  return JSON.stringify({
    ...
    review: [
      ...
      {
        "@type": "Review",
        author: { "@type": "Person", name: "L, Northampton" },
        reviewRating: {
          "@type": "Rating",
          ratingValue: "5",
          bestRating: "5",
